...
{
    [Serializable]
    class AssetIndexDataSource2 : IndexDataSource2
    {
        protected AssetIndexDataSource2() { }


        public AssetIndexDataSource2(LoginUser loginUser, int organizationID, string table, int[] idList, Logs logs)
