...
{
    [Serializable]
    class ProductIndexDataSource2 : IndexDataSource2
    {
        protected ProductIndexDataSource2() { }
        public ProductIndexDataSource2(LoginUser loginUser, int organizationID, string table, int[] idList, Logs logs)
