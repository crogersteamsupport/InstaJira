...
{
    [Serializable]
    class ProductVersionIndexDataSource2 : IndexDataSource2
    {
        protected ProductVersionIndexDataSource2() { }

        public ProductVersionIndexDataSource2(LoginUser loginUser, int organizationID, string table, int[] idList, Logs logs)
